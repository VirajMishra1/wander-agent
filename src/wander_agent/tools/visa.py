...
VISA_DATA: dict[str, dict[str, set[str]]] = {
    "us": {
        "visa_free": {"GB", "FR", "DE", "IT", "ES", "PT", "NL", "BE", "CH", "AT",
                       ...
                       "PE", "CL", "AR", "UY", "FJ", "ZA", "IL", "MA",
                       "EG", "TR", "GE", "AM", "AL", "RS", "ME", "BA", "MK", "IS"},
        "eta_required": {"AU", "NZ", "GB", "CA"},
    ...
    "jp": {
        "visa_free": {
            "US", "GB", "CA", "AU", "NZ", "FR", "DE", "IT", "ES", "PT", "NL", "BE",
            "CH", "AT", "DK", "SE", "NO", "FI", "IE", "GR", "PL", "CZ", "HU", "IS",
            "SG", "HK", "MY", "TH", "ID", "PH", "KR", "TW", "MX", "BR", "AR", "CL",
            "PE", "CO", "EC", "ZA", "IL", "TR", "AE", "QA", "MA", "TN", "RS", "HR",
            "ME", "AL", "MK", "BA", "BG", "RO", "EE", "LV", "LT", "LU", "MT", "CY",
            "SK", "SI", "IN", "DO", "PA", "CR", "GT", "HN", "SV", "NI", "JM", "BB",
            "TT", "BS", "VN",
        },
        "eta_required": set(),
        "evisa": {"KE", "TZ", "UG", "RW", "EG", "KH", "LA", "MM"},
        "visa_on_arrival": {"NP", "LK", "MV", "BO", "JO"},
    },
    "kr": {
        "visa_free": {
            "US", "GB", "CA", "AU", "NZ", "JP", "SG", "HK", "TW", "MY", "TH", "ID",
            "PH", "FR", "DE", "IT", "ES", "PT", "NL", "BE", "CH", "AT", "DK", "SE",
            "NO", "FI", "IE", "GR", "PL", "CZ", "HU", "IS", "MX", "BR", "AR", "CL",
            "ZA", "IL", "TR", "AE", "MA", "RS", "HR", "BG", "RO",
        },
        "eta_required": set(),
        "evisa": {"IN", "VN", "KH", "LA", "MM", "KE", "TZ", "UG"},
        "visa_on_arrival": {"NP", "LK", "MV", "JO", "EG", "BO"},
    },
    "sg": {
        "visa_free": {
            "US", "GB", "CA", "AU", "NZ", "JP", "KR", "HK", "TW", "MY", "TH", "ID",
            "PH", "FR", "DE", "IT", "ES", "PT", "NL", "BE", "CH", "AT", "DK", "SE",
            "NO", "FI", "IE", "GR", "PL", "CZ", "HU", "IS", "MX", "BR", "AR", "CL",
            "ZA", "IL", "TR", "AE", "MA", "RS", "HR", "BG", "RO", "IN", "VN", "KH",
            "MM", "LA", "LK", "MV", "JO", "EG", "QA", "OM", "BH", "KW",
        },
        "eta_required": set(),
        "evisa": {"CN", "RU", "SA", "KE", "TZ"},
        "visa_on_arrival": {"NP", "BO"},
    },
    "fr": {
        "visa_free": {
            "US", "GB", "CA", "AU", "NZ", "JP", "KR", "SG", "MY", "TH", "ID", "PH",
            "HK", "TW", "MX", "BR", "AR", "CL", "PE", "CO", "ZA", "IL", "TR", "AE",
            "MA", "EG",
            "DE", "IT", "ES", "PT", "NL", "BE", "CH", "AT", "DK", "SE", "NO", "FI",
            "IE", "GR", "PL", "CZ", "HU", "IS", "LU", "MT", "CY", "SK", "SI",
            "EE", "LV", "LT", "BG", "RO", "HR", "RS", "AL", "ME", "MK", "BA",
        },
        "eta_required": set(),
        "evisa": {"IN", "VN", "RU", "CN", "SA", "KE", "TZ"},
        "visa_on_arrival": {"NP", "LK", "MV", "JO", "KH", "LA"},
    },
    "es": {
        "visa_free": {
            "US", "GB", "CA", "AU", "NZ", "JP", "KR", "SG", "MY", "TH", "ID", "PH",
            "HK", "TW", "MX", "BR", "AR", "CL", "PE", "CO", "ZA", "IL", "TR", "AE",
            "MA", "EG",
            "FR", "DE", "IT", "PT", "NL", "BE", "CH", "AT", "DK", "SE", "NO", "FI",
            "IE", "GR", "PL", "CZ", "HU", "IS", "LU", "MT", "CY", "SK", "SI",
            "EE", "LV", "LT", "BG", "RO", "HR", "RS", "AL", "ME", "MK", "BA",
        },
        "eta_required": set(),
    ...
    "it": {
        "visa_free": {
            ...
            "HK", "TW", "MX", "BR", "AR", "CL", "PE", "CO", "ZA", "IL", "TR", "AE",
            "MA", "EG",
            "FR", "DE", "ES", "PT", "NL", "BE", "CH", "AT", "DK", "SE", "NO", "FI",
            "IE", "GR", "PL", "CZ", "HU", "IS", "LU", "MT", "CY", "SK", "SI",
            "EE", "LV", "LT", "BG", "RO", "HR", "RS", "AL", "ME", "MK", "BA",
        },
        "eta_required": set(),
    ...
    "nl": {
        "visa_free": {
            "US", "GB", "CA", "AU", "NZ", "JP", "KR", "SG", "MY", "TH", "ID", "PH",
            "HK", "TW", "MX", "BR", "AR", "CL", "ZA", "IL", "TR", "AE", "MA",
            "FR", "DE", "IT", "ES", "PT", "BE", "CH", "AT", "DK", "SE", "NO", "FI",
            "IE", "GR", "PL", "CZ", "HU", "IS", "LU", "MT", "CY", "SK", "SI",
            "EE", "LV", "LT", "BG", "RO", "HR", "RS", "AL", "ME",
        },
        "eta_required": set(),
        "evisa": {"IN", "VN", "RU", "CN", "SA"},
        "visa_on_arrival": {"NP", "LK", "MV", "JO"},
    ...
    "se": {
        "visa_free": {
            "US", "GB", "CA", "AU", "NZ", "JP", "KR", "SG", "MY", "TH", "MX", "BR",
            "AR", "CL", "ZA", "IL", "AE",
            "FR", "DE", "IT", "ES", "PT", "NL", "BE", "CH", "AT", "DK", "NO", "FI",
            "IE", "GR", "PL", "CZ", "HU", "IS", "LU", "MT", "SK", "SI",
            "EE", "LV", "LT", "BG", "RO", "HR", "RS",
        },
        "eta_required": set(),
        "evisa": {"IN", "VN", "RU", "CN", "SA"},
        "visa_on_arrival": {"NP", "LK", "MV", "JO"},
    ...
    "ch": {
        "visa_free": {
            "US", "GB", "CA", "AU", "NZ", "JP", "KR", "SG", "MY", "TH", "HK", "TW",
            "MX", "BR", "AR", "CL", "ZA", "IL", "TR", "AE", "MA",
            "FR", "DE", "IT", "ES", "PT", "NL", "BE", "AT", "DK", "SE", "NO", "FI",
            "IE", "GR", "PL", "CZ", "HU", "IS", "LU", "MT", "SK", "SI",
            "EE", "LV", "LT", "BG", "RO", "HR", "RS", "AL", "ME",
        },
        "eta_required": set(),
        "evisa": {"IN", "VN", "RU", "CN", "SA", "KE"},
        "visa_on_arrival": {"NP", "LK", "MV", "JO"},
    },
    "nz": {
        "visa_free": {
            "US", "GB", "CA", "AU", "JP", "KR", "SG", "MY", "TH", "HK", "TW",
            "FR", "DE", "IT", "ES", "PT", "NL", "BE", "CH", "AT", "DK", "SE", "NO",
            "FI", "IE", "GR", "PL", "CZ", "HU", "IS", "MX", "BR", "AR", "CL",
            "ZA", "IL", "TR", "AE", "MA", "RS", "HR",
        },
        "eta_required": {"AU", "US", "CA", "GB"},
        "evisa": {"IN", "VN", "RU", "CN", "SA"},
        "visa_on_arrival": {"NP", "LK", "MV", "JO", "ID", "TH"},
    },
    "br": {
        "visa_free": {
            "US", "GB", "CA", "AU", "NZ", "JP", "KR", "SG", "TH", "TR", "AE", "MA",
            "FR", "DE", "IT", "ES", "PT", "NL", "BE", "CH", "AT", "DK", "SE", "NO",
            "FI", "IE", "GR", "PL", "CZ", "HU", "IS", "AR", "CL", "PE", "CO", "UY",
            "PY", "BO", "EC", "VE", "MX", "DO", "PA", "CR",
        },
        "eta_required": set(),
        "evisa": {"IN", "VN", "CN", "RU", "KE", "TZ", "EG"},
        "visa_on_arrival": {"NP", "LK", "MV", "TH", "ID", "JO"},
    },
    "mx": {
        "visa_free": {
            "US", "CA", "GB", "AU", "NZ", "JP", "KR", "SG", "TR", "AE",
            "FR", "DE", "IT", "ES", "PT", "NL", "BE", "CH", "AT", "DK", "SE", "NO",
            "FI", "IE", "GR", "PL", "CZ", "HU", "IS", "AR", "CL", "PE", "CO", "BR",
            "DO", "PA", "CR", "GT", "HN", "SV", "NI", "HK",
        },
        "eta_required": set(),
        "evisa": {"IN", "VN", "CN", "RU", "EG"},
        "visa_on_arrival": {"NP", "LK", "MV", "TH", "ID", "JO", "BO"},
    },
    "za": {
        "visa_free": {
            "GB", "US", "CA", "AU", "NZ", "JP", "KR", "SG", "MY", "TH", "HK", "TW",
            "FR", "DE", "IT", "ES", "PT", "NL", "BE", "CH", "AT", "DK", "SE", "NO",
            "FI", "IE", "GR", "IS", "TR", "AR", "BR", "CL", "MX", "IL",
            "MW", "MZ", "ZW", "BW", "NA", "SZ", "LS",
        },
        "eta_required": set(),
        "evisa": {"IN", "VN", "EG", "KE", "TZ", "UG", "RW", "KH", "LA"},
        "visa_on_arrival": {"NP", "LK", "MV", "ID", "TH", "JO", "BO", "EC"},
        "visa_required": {"CN", "RU", "PK", "BD", "NG", "GH", "SN", "CM"},
    },
    "ae": {
        "visa_free": {
            "US", "GB", "CA", "AU", "NZ", "JP", "KR", "SG", "MY", "TH", "ID", "PH",
            "HK", "TW", "MX", "BR", "AR", "CL", "ZA", "IL", "TR", "MA",
            "FR", "DE", "IT", "ES", "PT", "NL", "BE", "CH", "AT", "DK", "SE", "NO",
            "FI", "IE", "GR", "PL", "CZ", "HU", "IS", "LU", "MT", "SK", "SI",
            "EE", "LV", "LT", "BG", "RO", "HR", "RS", "AL", "ME", "MK",
            "QA", "KW", "BH", "OM", "SA",
        },
        "eta_required": set(),
        "evisa": {"IN", "VN", "CN", "RU", "PK", "KE", "TZ", "EG"},
        "visa_on_arrival": {"NP", "LK", "MV", "JO", "BO"},
    },
    "pt": {
        "visa_free": {
            "US", "GB", "CA", "AU", "NZ", "JP", "KR", "SG", "MY", "TH", "HK", "TW",
            "MX", "BR", "AR", "CL", "ZA", "IL", "TR", "AE", "MA",
            "FR", "DE", "IT", "ES", "NL", "BE", "CH", "AT", "DK", "SE", "NO", "FI",
            "IE", "GR", "PL", "CZ", "HU", "IS", "LU", "MT", "SK", "SI",
            "EE", "LV", "LT", "BG", "RO", "HR", "RS", "AL", "ME",
        },
        "eta_required": set(),
