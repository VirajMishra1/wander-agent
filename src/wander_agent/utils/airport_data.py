...
POPULAR_DESTINATIONS: list[tuple[str, str, str, str]] = [
    ...
    ("EDI", "Edinburgh", "United Kingdom", "europe"),
    ("KEF", "Reykjavik", "Iceland", "europe"),
    ("OPO", "Porto", "Portugal", "europe"),
    ("DBV", "Dubrovnik", "Croatia", "europe"),
    ("SPU", "Split", "Croatia", "europe"),
    ("SOF", "Sofia", "Bulgaria", "europe"),
    ("OTP", "Bucharest", "Romania", "europe"),
    ("RIX", "Riga", "Latvia", "europe"),
    ("VNO", "Vilnius", "Lithuania", "europe"),
    ("TLL", "Tallinn", "Estonia", "europe"),
    ("SKG", "Thessaloniki", "Greece", "europe"),
    ("SAW", "Istanbul Sabiha", "Turkey", "europe"),
    # Asia extras
    ("PEK", "Beijing", "China", "asia"),
    ("PVG", "Shanghai", "China", "asia"),
    ("CTU", "Chengdu", "China", "asia"),
    ("HAN", "Hanoi", "Vietnam", "asia"),
    ("SGN", "Ho Chi Minh City", "Vietnam", "asia"),
    ("DAD", "Da Nang", "Vietnam", "asia"),
    ("REP", "Siem Reap", "Cambodia", "asia"),
    ("PNH", "Phnom Penh", "Cambodia", "asia"),
    ("CMB", "Colombo", "Sri Lanka", "asia"),
    ("MLE", "Male", "Maldives", "asia"),
    ("KTM", "Kathmandu", "Nepal", "asia"),
    ("TBS", "Tbilisi", "Georgia", "asia"),
    ("KIX", "Osaka", "Japan", "asia"),
    ("OKA", "Okinawa", "Japan", "asia"),
    ("FUK", "Fukuoka", "Japan", "asia"),
    ("MNL", "Manila", "Philippines", "asia"),
    ("CEB", "Cebu", "Philippines", "asia"),
    ("CGK", "Jakarta", "Indonesia", "asia"),
    # Middle East extras
    ("DOH", "Doha", "Qatar", "middle_east"),
    ("RUH", "Riyadh", "Saudi Arabia", "middle_east"),
    ("JED", "Jeddah", "Saudi Arabia", "middle_east"),
    ("MCT", "Muscat", "Oman", "middle_east"),
    ("AMM", "Amman", "Jordan", "middle_east"),
    ("TLV", "Tel Aviv", "Israel", "middle_east"),
    ("BAH", "Manama", "Bahrain", "middle_east"),
    # Africa extras
    ("CMN", "Casablanca", "Morocco", "africa"),
    ("RAK", "Marrakech", "Morocco", "africa"),
    ("TUN", "Tunis", "Tunisia", "africa"),
    ("ADD", "Addis Ababa", "Ethiopia", "africa"),
    ("DAR", "Dar es Salaam", "Tanzania", "africa"),
    ("ZNZ", "Zanzibar", "Tanzania", "africa"),
    ("KGL", "Kigali", "Rwanda", "africa"),
    ("ACC", "Accra", "Ghana", "africa"),
    ("LOS", "Lagos", "Nigeria", "africa"),
    ("DKR", "Dakar", "Senegal", "africa"),
    # Americas extras
    ("BOG", "Bogota", "Colombia", "americas"),
    ("MDE", "Medellin", "Colombia", "americas"),
    ("SCL", "Santiago", "Chile", "americas"),
    ("EZE", "Buenos Aires", "Argentina", "americas"),
    ("MVD", "Montevideo", "Uruguay", "americas"),
    ("GIG", "Rio de Janeiro", "Brazil", "americas"),
    ("BSB", "Brasilia", "Brazil", "americas"),
    ("PTY", "Panama City", "Panama", "americas"),
    ("SJO", "San Jose", "Costa Rica", "americas"),
    ("HAV", "Havana", "Cuba", "americas"),
    ("SDQ", "Santo Domingo", "Dominican Republic", "americas"),
    ("SJU", "San Juan", "Puerto Rico", "americas"),
    ("BGI", "Bridgetown", "Barbados", "americas"),
    ("UIO", "Quito", "Ecuador", "americas"),
    # Oceania extras
    ("MEL", "Melbourne", "Australia", "oceania"),
    ("BNE", "Brisbane", "Australia", "oceania"),
    ("PER", "Perth", "Australia", "oceania"),
    ("CHC", "Christchurch", "New Zealand", "oceania"),
    ("NAN", "Nadi", "Fiji", "oceania"),
]
